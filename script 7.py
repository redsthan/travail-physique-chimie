...
for i in range (len(t)-1): # len donne le nombre d’éléments d’une liste
    ...
    print("A la hauteur",y[i],"m" ,"la vitesse atteinte par Laso Schaller est de",-3.6*vy[i], "km/h")
    plt.arrow(x[i],y[i],vx[i]/echelle,vy[i]/echelle,head_width=largeur,head_length=longueur,length_includes_head = True)
